...
Docelowy adres: `/dla-mediow/`

Opublikować treść znajdującą się poniżej linii. Nie publikować niniejszego bloku administracyjnego. Nie tworzyć osobnej strony ani pliku PDF z komunikatem prasowym — ta strona jest kompletnym źródłem informacji dla redakcji.

---

# Dla mediów: protest w sprawie legalizacji pobytu w Gdańsku

Materiały, dane, postulaty i informacje organizacyjne dotyczące pokojowego zgromadzenia 7 września 2026 r. przed Pomorskim Urzędem Wojewódzkim.
...
Tu Żyjemy jest oddolną inicjatywą mieszkańców, którzy chcą wspólnie działać wobec problemów publicznych. Legalizacja pobytu jest naszą pierwszą inicjatywą, ale nie definiuje całej platformy.

## Dlaczego protestujemy

Nie występujemy przeciwko pracownikom urzędu. Występujemy przeciwko systemowi, w którym państwo przyjmuje wniosek i opłatę, a następnie przez wiele miesięcy lub lat nie wydaje decyzji ani nie przedstawia wiarygodnego planu usunięcia zaległości.
...
Problem dotyczy nie tylko prywatnych podróży. Podczas rozdawania ulotek pracownica polskiej firmy transportowej wzięła większą liczbę materiałów po rosyjsku i ukraińsku, aby przekazać je w swojej firmie. Wyjaśniła, że opóźnienia w wydawaniu kart pobytu utrudniają wysyłanie kierowców w trasy zagraniczne.

Kierowca może pracować i mieszkać w Polsce, lecz brak aktualnego dokumentu pobytowego może uniemożliwić mu bezpieczne przekraczanie granicy i wykonywanie międzynarodowych kursów. Konsekwencje ponosi pracownik, jego rodzina oraz przedsiębiorstwo, które nie może normalnie planować przewozów. Podobne problemy zgłaszają osoby zawodowo zajmujące się legalizacją pobytu.

Ludzie nie są teczkami, które można odłożyć na półkę. Urzędowa procedura nie może na lata zatrzymywać zwykłego życia i wykonywania normalnej pracy.

## Ile trwa cała droga? 26–28 miesięcy

Według danych projektu [Pobytrack](https://t.me/pobytrack) pełna droga od złożenia wniosku do odbioru karty w obserwowanych sprawach w Gdańsku trwała pod koniec lipca 2026 r. **26–28 miesięcy**.
...
[Źródło: Dolnośląski Urząd Wojewódzki](https://www.gov.pl/web/dolnoslaski-uw/wydzial-spraw-obywatelskich-i-cudzoziemcow-w-2025-roku)
...
[Zobacz porównanie Pomorskiego, Małopolski i Dolnego Śląska](https://tuzyjemy.pl/statystyki/pomorskie-malopolska-dolny-slask/)

## Najważniejsze kierunki zmian

### 1. Plan i jawne dane

Publiczny plan redukcji zaległości z terminami i miesięcznymi celami, pełna informacja o liczbie i wieku spraw oraz regularna publikacja rzeczywistych czasów oczekiwania i etapów, na których powstają opóźnienia.

### 2. Sprawna organizacja postępowań

Odpowiednia obsada, rozliczenie efektów projektu FAMI, rozpoczynanie możliwych czynności przed biometrią, koordynowanie spraw rodzinnych, kontynuowanie możliwej pracy po przekazaniu akt do WSA oraz terminowa obsługa formalnych pism.

### 3. Odpowiedzialność państwa i sprawny proces cyfrowy

Uchylenie art. 100d, szybkie procedury oparte na obiektywnych cechach sprawy zamiast obywatelstwa, uproszczenia dla spraw powtarzalnych i rodzinnych oraz integracja MOS 2 ze ST POBYT, EZD, systemami wojewódzkimi i rejestrami państwowymi.

[Przeczytaj pełne 16 postulatów wraz z uzasadnieniem](https://tuzyjemy.pl/postulaty/)

## Materiały i źródła

- [Informacje dla uczestników protestu](https://tuzyjemy.pl/aktualnosci/protest-7-wrzesnia/)
- [Pełne 16 postulatów](https://tuzyjemy.pl/postulaty/)
- [Statystyki](https://tuzyjemy.pl/statystyki/)
- [Statystyka orzeczeń WSA/NSA](https://tuzyjemy.pl/orzeczenia/)
- [Historia działań i złożonych dokumentów](https://tuzyjemy.pl/dzialania/)
- [Oficjalna rejestracja zgromadzenia w BIP](https://bip.gdansk.pl/urzad-miejski/zgromadzenia-publiczne/Data-07-09-2026r-Czas-trwania-16-30-18-00,a,317325)

## Kontakt dla mediów

[contact@tuzyjemy.pl](mailto:contact@tuzyjemy.pl)

Rozmowy z organizatorami i uczestnikami będą możliwe na miejscu. W sprawie wcześniejszych rozmów prosimy o kontakt mailowy.
