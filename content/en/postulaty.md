...
We expect a report on the implementation of the project ["Strengthening the capacity of the Pomeranian Voivode in serving foreigners in the Pomeranian Voivodeship"](https://www.gov.pl/web/uw-pomorski/fundusz-azylu-migracji-i-integracji-2021--2029), worth PLN 12,885,333.33.
...
On 24 June 2026 we formally submitted a package of three documents: a petition to the Pomeranian Voivode, a petition to the Petitions Committee of the Sejm, and a letter to the Ministry of Digital Affairs and the Head of the Office for Foreigners. [The package has already been supported by more than 3,700 people](https://www.petycjeonline.com/trzy_dokumenty_jeden_pakiet_dziaa_na_rzecz_usprawnienia_procesu_legalizacji_pobytu_cudzoziemcow).
...
Such a mechanism creates a risk of unequal treatment by public authority on grounds of nationality. [Art. 32 of the Constitution](https://eli.gov.pl/eli/DU/1997/483/ogl) guarantees everyone the right to equal treatment by public authorities. Not every differentiation between foreigners on grounds of nationality is automatically unlawful, but it must have an objective, rational and proportionate justification. In our view, an investment interest connected with the country of origin should not by itself determine who receives a decision in 60 days and who remains in a queue lasting years.
